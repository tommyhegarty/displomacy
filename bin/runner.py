import disnake, os, cfg, datetime, random
    ...
    for order, success in completed:
        ...
        for c in gv.countries:
            if dislodge_possible in gamedoc['state'][c]['armies']:
                dislodged.append({'country': c, 'unit_type': 'A', 'unit_location': dislodge_possible})
                gamedoc['state'][c]['armies'].remove(dislodge_possible)
                dislodged_country = c
            elif dislodge_possible in gamedoc['state'][c]['fleets']:
                dislodged.append({'country': c, 'unit_type': 'F', 'unit_location': dislodge_possible})
